...
const App = () => {
 ...
 xl:w-1/2 lg:w-11/12 md:w-full sm:w-full
      text-white 
      "
      >
        <img
...
xl:text-center lg:text-center md:text-left sm:text-left
  font-semibold"
            ...
            <div
              className="grid xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 gap-8 w-full h-auto mt-8
   
          "
            >
              <div
                className="col-span-1 px-3 py-8 gap-2 items-start rounded-lg border-[1px] 
            border-[#313131] flex flex-col bg-[#0oo] "
              >
                <FontAwesomeIcon
                  icon={faBlog}
                  className="text-2xl rounded-full
               bg-transparent text-[#fff] p-3"
                />
                <span className="ml-2 text-lg mt-2">Bloq</span>
                <p className="text-[#fff] ml-2  tracking-wider leading-[25px] text-sm ">
                  Bloqlar hissəsində müxtəlif mütəxəssislərin yazılarını oxuya
                  və öz təcrübələrinizi də bölüşərək, başqalarına kömək edə
                  bilərsiniz.
                </p>
              </div>

              <div className="col-span-1 px-3 py-8 gap-2 items-start rounded-lg border-[1px] border-[#313131] 
              flex flex-col  bg-[#0oo]">
                <FontAwesomeIcon
                  icon={faPodcast}
                  className="text-2xl rounded-full
              ...
              <div className="col-span-1 px-3 py-8 gap-2 items-start rounded-lg border-[1px] border-[#313131] flex 
              flex-col  bg-[#0oo]">
                <FontAwesomeIcon
                  icon={faBook}
                  className="text-2xl rounded-full
